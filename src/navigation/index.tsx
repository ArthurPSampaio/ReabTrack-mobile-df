...
export default function RootNavigator() {
  return (
    <Stack.Navigator initialRouteName="PatientsList">
      ...
      <Stack.Screen name="PatientNew" component={PatientNewScreen} options={{ title: 'Novo Paciente' }} />
      ...
      <Stack.Screen name="PlanCreate" component={PlanCreateScreen} options={{ title: 'Novo Plano' }} />
    </Stack.Navigator>
  );
}
